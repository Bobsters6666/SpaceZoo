  ...
  return (
    <div className="quiz-container">
      ...
      <div className="question-container">
        <p>
          Q. Which of the following is not an animal that lives on the beach?
        </p>
      </div>
            ...
            <div className="modal-explain-container">
              ...
              <div>
                <p className="modal-explain">
                  The kiwi bird is a national symbol of New Zealand but it lives
                  in forests, not on beaches. Kiwis are flightless, nocturnal
                  birds.
                </p>
              </div>
            </div>
